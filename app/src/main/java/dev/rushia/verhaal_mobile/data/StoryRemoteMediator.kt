package dev.rushia.verhaal_mobile.data
...
import dev.rushia.verhaal_mobile.data.local.database.RemoteKeys
...
class StoryRemoteMediator(
    ...
    override suspend fun load(
        ...
        try {
            val responseData = apiService.getStoriesListPage(token, page, state.config.pageSize)
            ...
            database.withTransaction {
                ...
                database.storyDao().insert(responseData.listStory)
            }
